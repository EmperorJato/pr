                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$row->name}}</td>
                                <td>
                                    <a href="{{route('admin.accounts', [$id=$row->id, $name=$row->name])}}" style="cursor: pointer; color: #51bcda;" class="viewUser" data-content="View User" rel="popover" data-placement="bottom">
...
<script type="text/javascript">
    ...
    $('.viewUser').popover({trigger : "hover focus"});
