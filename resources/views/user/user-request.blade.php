                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr id="{{$row->pr_id}}">
                            ...
                            <td>{{$row->purpose}}</td>
                            <td>
                                {{-- <a href="{{route('view.pdf', [$id=$row->pr_id, $requestor=$row->requestor])}}" target="_blank" style="cursor: pointer; color: #51cbce;" class="viewData" data-content="View PDF" rel="popover" data-placement="bottom">
                                    <i class="fas fa-eye" style="font-size: 20px;"></i>
                                </a>&nbsp; --}}
                                <a href="{{route('user-send', [$id=$row->pr_id, $requestor=$row->requestor])}}" style="cursor: pointer; color: #7de883;" class="approvalData" data-content="Approve" rel="popover" data-placement="bottom">
