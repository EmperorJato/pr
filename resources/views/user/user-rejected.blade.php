                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr id="{{$row->pr_id}}">
                            ...
                            <td>{{$row->purpose}}</td>
                            <td>
                                <a href="{{route('user-send', [$id=$row->pr_id, $requestor=$row->requestor])}}" style="cursor: pointer; color: #51cbce;" class="viewData" data-content="View Request" rel="popover" data-placement="bottom">
